...
from sea.engine.harlowe_processor.helper_functions import compile_re
...
class HarlowePassage:
    ...
    Attributes:
        ...
        macros (ordered dict of HarloweMacro): ordered dict of macros to execute at the startup
    """
    ...
    def __str__(self):
        str_list = ['<{} pid="{}" name="{}" tags="{}">'.format(_PASSAGE_TAG, self.pid,
...
def parse_harlowe_html(s):
    ...
    story_elem = html5lib.parseFragment(s, treebuilder='lxml', namespaceHTMLElements=False)
    story_elem = story_elem[0]
